...
void dmaTransferSource(DMA_CH_t &channel, const std::uintptr_t address)
{
...
void dmaTransferSource(DMA_CH_t &channel, const void *const address)
	{ dmaTransferSource(channel, reinterpret_cast<std::uintptr_t>(address)); }
void dmaTransferSource(DMA_CH_t &channel, const volatile void *const address)
	{ dmaTransferSource(channel, reinterpret_cast<std::uintptr_t>(address)); }

void dmaTransferDest(DMA_CH_t &channel, const std::uintptr_t address)
{
